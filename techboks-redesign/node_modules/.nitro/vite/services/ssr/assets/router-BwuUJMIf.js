...
import { HeadContent, Link, Outlet, Scripts, createFileRoute, createRootRouteWithContext, createRouter, notFound, useRouter } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { QueryClient, QueryClientProvider } from "@tanstack/react-query";
import { AnimatePresence, motion, useAnimationFrame, useMotionValue, useScroll, useSpring, useTransform, useVelocity } from "motion/react";
import { ArrowDown, ArrowLeft, ArrowRight, ArrowUpRight, Boxes, Check, Instagram, LayoutGrid, Leaf, MapPin, Menu, MessageCircle, Minus, Plus, Rows3, Search, ShieldCheck, ShoppingBag, Trash2, X } from "lucide-react";
import { z } from "zod";
...
//#endregion
//#region src/assets/homey-pro-cover.jpg
...
//#endregion
//#region src/assets/logo-mark-c.png
...
function Logo({ className = "" }) {
	return /* @__PURE__ */ jsxs(Link, {
		...
		children: [/* @__PURE__ */ jsx("img", {
			...
			children: ["Tech", /* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/components/CartPanel.tsx
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(AnimatePresence, {
					initial: false,
					children: lines.length === 0 ? /* @__PURE__ */ jsx(motion.p, {
						initial: { opacity: 0 },
						animate: { opacity: 1 },
						exit: { opacity: 0 },
					...
					}, "empty") : /* @__PURE__ */ jsx("ul", {
						className: "space-y-2",
						children: lines.map((line) => /* @__PURE__ */ jsxs(motion.li, {
							layout: true,
							initial: {
								opacity: 0,
								x: 24
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: ["Se kurven", /* @__PURE__ */ jsx("span", {
...
function Header() {
	...
	return /* @__PURE__ */ jsxs("header", {
					...
					children: [
						/* @__PURE__ */ jsxs("button", {
							...
							children: [
								...
								"Kurv",
								count > 0 && /* @__PURE__ */ jsx(motion.span, {
									initial: { scale: .5 },
									animate: { scale: 1 },
						...
						/* @__PURE__ */ jsx(AnimatePresence, { children: cartOpen && /* @__PURE__ */ jsx(motion.div, {
							initial: {
								opacity: 0,
								y: -10,
								scale: .97
							...
							children: /* @__PURE__ */ jsx(CartPanel, { onNavigate: () => setCartOpen(false) })
						}) }),
						/* @__PURE__ */ jsx("button", {
							type: "button",
							onClick: () => setOpen((v) => !v),
		...
		}), /* @__PURE__ */ jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsx(motion.nav, {
			initial: {
				opacity: 0,
				y: -8
			},
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
						...
						children: [
							categories.map((c) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
								to: "/produkter",
								search: {
									kategori: c.slug,
									q: ""
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("li", { children: "info@techboks.dk" }),
							/* @__PURE__ */ jsx("li", { children: "Betaling via MobilePay" }),
							/* @__PURE__ */ jsx("li", { children: "Fragt med GLS / PostNord" })
						]
					})] })
				]
			}), /* @__PURE__ */ jsxs("div", {
				...
				] }), /* @__PURE__ */ jsx("span", { children: "CVR · Handelsbetingelser · Privatlivspolitik" })]
			})]
		})
	});
}
...
function RootComponent() {
	...
	return /* @__PURE__ */ jsx(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ jsx(CartProvider, { children: /* @__PURE__ */ jsxs("div", {
...
function Marquee({ items, baseSpeed = 40 }) {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(motion.div, {
			...
			children: row.map((item, i) => /* @__PURE__ */ jsxs("span", {
...
//#endregion
//#region src/components/ScrollText.tsx
...
function ScrollText({ text, className = "" }) {
	...
	return /* @__PURE__ */ jsx("p", {
		...
		children: words.map((word, i) => /* @__PURE__ */ jsx(Word, {
...
function Home() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(StackedCategories, {}),
			/* @__PURE__ */ jsx(ProductStrip, {}),
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "from-surface via-surface/90 sm:via-surface/70 absolute inset-0 bg-gradient-to-r to-transparent to-85% sm:via-45%" }),
				/* @__PURE__ */ jsx(motion.div, {
					style: { opacity: veil },
				...
				/* @__PURE__ */ jsxs(motion.div, {
					...
					children: [
						...
						/* @__PURE__ */ jsx("h1", {
							...
							children: ["Tilbehør der er", "tegnet til at passe."].map((line, i) => /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs(motion.div, {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: ["Se produkter", /* @__PURE__ */ jsx("span", {
			...
			className: "mt-3",
			children: /* @__PURE__ */ jsx(Marquee, { items: [
				"0,2 mm laghøjde",
				"Printet i Danmark",
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				].map(([value, label, bg], i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i * .08,
...
function StackedCategories() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
			...
			children: categories.map((c, i) => /* @__PURE__ */ jsx(MergeCard, {
				index: i,
				children: /* @__PURE__ */ jsxs(Link, {
					to: "/produkter",
					search: {
...
function ProductStrip() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsx("span", {
			className: "text-muted-foreground text-xs tracking-[0.24em] uppercase",
			children: "Et udpluk"
		}), /* @__PURE__ */ jsx("h2", {
			...
			children: [preview.map((p, i) => /* @__PURE__ */ jsx(FlyInCard, {
				index: i,
				...
				children: [
					...
					children: /* @__PURE__ */ jsxs(motion.div, {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "absolute top-6 right-6 h-2 w-2 rounded-full bg-current opacity-20" }),
							/* @__PURE__ */ jsx("div", { className: "absolute right-10 bottom-10 h-16 w-16 rounded-full bg-current opacity-[0.03]" })
						]
					})
				}, b.title))
			})]
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("h2", {
				...
				children: ["Gå til kataloget", /* @__PURE__ */ jsx("span", {
...
function OrderPage() {
	...
	if (status === "done") return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs(motion.div, {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "bg-accent-mint/25 pointer-events-none absolute -top-24 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full blur-3xl" }),
				/* @__PURE__ */ jsx(motion.div, {
					initial: { scale: 0 },
					animate: { scale: 1 },
					transition: {
				...
				/* @__PURE__ */ jsxs(Link, {
					...
					children: ["Tilbage til produkterne", /* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs(motion.header, {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "bg-accent-mint/20 pointer-events-none absolute -right-16 -bottom-24 h-72 w-72 rounded-full blur-3xl" }),
				/* @__PURE__ */ jsx("span", {
					className: "text-canvas/50 text-xs tracking-[0.24em] uppercase",
			...
			children: [/* @__PURE__ */ jsxs(motion.form, {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("button", {
						...
						children: [status === "sending" ? "Sender…" : "Send ordreforespørgsel", /* @__PURE__ */ jsx("span", {
							className: "bg-accent-mint text-accent-mint-foreground grid h-10 w-10 place-items-center rounded-full transition-transform group-hover:translate-x-1",
							children: /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })
						})]
					}),
				...
				children: [
					...
					/* @__PURE__ */ jsxs("ul", {
						...
						children: [lines.map((line) => /* @__PURE__ */ jsxs("li", {
						...
						}, `${line.productId}-${line.variant ?? ""}`)), lines.length === 0 && /* @__PURE__ */ jsx("li", {
...
var contactSchema = z.object({
	...
	message: z.string().trim().min(1, "Skriv en besked").max(1e3, "Beskeden er for lang")
});
var channels = [{
	icon: MessageCircle,
	label: "Messenger",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [channels.map((c, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i * .08,
					children: /* @__PURE__ */ jsxs("a", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("span", {
								...
								children: [c.cta, /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" })]
							})
						]
					})
				}, c.label)), /* @__PURE__ */ jsx(Reveal, {
					delay: .16,
					children: /* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("p", { children: "For bestilling kontakter du mig via formularen eller Messenger. Skriv hvilke produkter du ønsker at bestille, samt eventuelle specialønsker." }),
									/* @__PURE__ */ jsx("p", { children: "Det er muligt at få tilsendt bestillingen eller afhente den i Aarhus N. Betaling sker via MobilePay, når ordren er bekræftet." }),
									/* @__PURE__ */ jsx("p", { children: "Jeg bestræber mig på at besvare alle henvendelser inden for 24 timer." })
								]
							}),
							/* @__PURE__ */ jsxs("a", {
								...
								children: ["Se handelsbetingelser", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
							})
						]
					})
				})]
...
function CartPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs(motion.header, {
			...
			className: "rounded-blob-lg bg-ink text-canvas relative overflow-hidden p-8 sm:p-12",
			children: [
				/* @__PURE__ */ jsx("div", { className: "bg-accent-mint/20 pointer-events-none absolute -top-24 -right-16 h-72 w-72 rounded-full blur-3xl" }),
				/* @__PURE__ */ jsx("span", {
					className: "text-canvas/50 text-xs tracking-[0.24em] uppercase",
		...
		}), lines.length === 0 ? /* @__PURE__ */ jsxs(motion.div, {
			initial: {
				opacity: 0,
				y: 20
			},
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(ShoppingBag, { className: "h-6 w-6" })
				}),
				/* @__PURE__ */ jsx("p", {
			...
			children: [/* @__PURE__ */ jsx("ul", {
				...
				children: /* @__PURE__ */ jsx(AnimatePresence, {
					initial: false,
					children: lines.map((line, i) => /* @__PURE__ */ jsxs(motion.li, {
						layout: true,
						initial: {
							opacity: 0,
							y: 24
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									line.variant && /* @__PURE__ */ jsx("span", {
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(QuantityControl, {
											line,
											setQuantity
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: ["Gå til ordreforespørgsel", /* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/assets/hero-workshop.jpg
var hero_workshop_default = "/assets/hero-workshop-Da0LK-Kw.jpg";
//#endregion
//#region src/routes/om.tsx
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("p", { children: "Hos TechBoks kombineres passion for design og innovation med funktionelle 3D printede produkter. Vi laver ting, der ikke bare ser godt ud, men også løser konkrete udfordringer i hverdagen." }),
							/* @__PURE__ */ jsx("p", { children: "Hvert produkt tegnes fra bunden med fokus på funktionalitet, holdbarhed og æstetik — fra specialdesignede bilgadgets til smarte løsninger i hjemmet. Alt produceres i små serier på egne printere med bæredygtige materialer og grøn strøm." }),
							/* @__PURE__ */ jsx("p", { children: "Visionen er enkel: at gøre gennemtænkte, funktionelle produkter tilgængelige for alle — og gøre din hverdag en anelse nemmere." })
						]
					}),
					/* @__PURE__ */ jsx(Link, {
						to: "/produkter",
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: options.map((o) => {
			...
			return /* @__PURE__ */ jsxs("button", {
				...
				children: [o.name, /* @__PURE__ */ jsx("span", {
...
function ProductGrid({ products, compact = false }) {
	if (products.length === 0) return /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: products.map((product, i) => /* @__PURE__ */ jsx(motion.div, {
			layout: true,
			initial: {
				opacity: 0,
				y: 16
...
//#endregion
//#region src/routes/produkter.index.tsx
		...
		children: [
			...
			/* @__PURE__ */ jsx(motion.div, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(CategoryFilter, {
						active: kategori,
						counts,
...
//#endregion
//#region src/routes/produkter.$slug.tsx
var Route = createFileRoute("/produkter/$slug")({
	...
	errorComponent: ({ error }) => /* @__PURE__ */ jsx("div", {
		className: "container-tb py-24",
		role: "alert",
		children: error.message
	}),
	notFoundComponent: () => /* @__PURE__ */ jsxs("div", {
...
function ProductDetailRoute() {
	...
	return /* @__PURE__ */ jsx(ProductDetail, { product });
}
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs(Link, {
				...
				children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "h-4 w-4" }), " Alle produkter"]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
					...
					children: product.images.map((src, i) => /* @__PURE__ */ jsx("button", {
						type: "button",
					...
					children: [
						...
						product.options?.map((option) => /* @__PURE__ */ jsxs("div", {
							className: "mt-8",
							children: [/* @__PURE__ */ jsx("h2", {
								className: "eyebrow",
								...
								children: option.values.map((value) => /* @__PURE__ */ jsx("button", {
									type: "button",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: added ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }), " Lagt i kurven"] }) : "Læg i kurv"
							})]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("h2", {
								...
								children: product.specifications.map((spec) => /* @__PURE__ */ jsxs("div", {
